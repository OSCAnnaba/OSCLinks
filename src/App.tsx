...
function App() {
  const links: {
  ...
  }[] = [
    {
      ...
      icon: (
        <FaTelegram className="w-12 h-12 md:w-16 md:h-16 text-[#229ED9] absolute opacity-0 group-hover:opacity-100 left-0 group-hover:left-[80%] sm:group-hover:left-[90%] transition-all duration-700" />
      ),
    },
    {
      type: "Github",
      ...
      icon: (
        <FaGithub className="w-12 h-12 md:w-16 md:h-16 text-black absolute opacity-0 group-hover:opacity-100 left-0 group-hover:left-[80%] sm:group-hover:left-[90%] transition-all duration-700" />
      ),
    },
    {
      type: "Email",
      ...
      icon: (
        <MdEmail className="w-12 h-12 md:w-16 md:h-16 text-gray-600 absolute opacity-0 group-hover:opacity-100 left-0 group-hover:left-[80%] sm:group-hover:left-[90%] transition-all duration-700" />
      ),
    },
  ];
